export default function Footer() {
  return (
    <footer className="bg-brown text-cream/70 py-12 mt-16">
      <div className="max-w-6xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-cream font-bold mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="hover:text-cream">Visualizations</a></li>
              <li><a href="#" className="hover:text-cream">Database</a></li>
              <li><a href="#" className="hover:text-cream">Methodology</a></li>
              <li><a href="#" className="hover:text-cream">Contact</a></li>
            </ul>
          </div>
          <div>
            <h4 className="text-cream font-semibold mb-4">Data Source</h4>
        ...
        <div className="border-t border-brown/30 mt-8 pt-8 text-center text-sm">
